...
class Timber private constructor() {
    ...
    class DebugTree : Tree() {
         ...
         * {@inheritDoc}
         */
        override fun log(priority: Int, tag: String?, messageObject: Any, t: Throwable?) {
            var message = messageObject.toString()
            if (messageObject is Exception) {
                message = (messageObject).cause.toString()
            }
...
fun Any.d() = Timber.d(this)
fun Any.e() = Timber.e(this)
fun Any.i() = Timber.i(this)
fun Any.wtf() = Timber.wtf(this)
fun Any.w() = Timber.w(this)
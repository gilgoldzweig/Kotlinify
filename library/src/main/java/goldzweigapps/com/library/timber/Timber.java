package goldzweigapps.com.library.timber;
...
import goldzweigapps.com.library.collections.CollectionExtentionsKt;
import goldzweigapps.com.library.views.ViewsExtentionKt;
...
public final class Timber {
    ...
    private static final Tree TREE_OF_SOULS = new Tree() {
        @Override
        public void v(Object message, Object... args) {
        ...
        @Override
        public void v(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void d(Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void d(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void i(Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void i(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void w(Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void w(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void e(Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void e(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void wtf(Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void wtf(Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void log(int priority, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        public void log(int priority, Throwable t, Object message, Object... args) {
            Tree[] forest = forestAsArray;
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
        ...
        @Override
        protected void log(int priority, String tag, Object message, Throwable t) {
     ...
     */
    public static void v(@NonNull Object message, Object... args) {
     ...
     */
    public static void v(Throwable t, @NonNull Object message, Object... args) {
     ...
     */
    public static void d(@NonNull Object message, Object... args) {
     ...
     */
    public static void d(Throwable t, @NonNull Object message, Object... args) {
     ...
     */
    public static void i(@NonNull Object message, Object... args) {
     ...
     */
    public static void i(Throwable t, @NonNull Object message, Object... args) {
     ...
     */
    public static void w(@NonNull Object message, Object... args) {
     ...
     */
    public static void w(Throwable t, @NonNull Object message, Object... args) {
     ...
     */
    public static void e(@NonNull Object message, Object... args) {
     ...
     */
    public static void e(Throwable t, @NonNull Object message, Object... args) {
    ...
    public static void e(Exception e) {
        if (e.getCause() == null) {
            TREE_OF_SOULS.e(e.getMessage());
        } else {
            TREE_OF_SOULS.e(e.getCause());
        }
    }
     ...
     */
    public static void wtf(@NonNull Object message, Object... args) {
     ...
     */
    public static void wtf(Throwable t, @NonNull Object message, Object... args) {
    ...
    /**
     * Log at {@code priority} a message workWith optional format args.
     */
    public static void log(int priority, @NonNull Object message, Object... args) {
        TREE_OF_SOULS.log(priority, message, args);
    }

    /**
     * Log at {@code priority} an exception and a message workWith optional format args.
     */
    public static void log(int priority, Throwable t, @NonNull Object message, Object... args) {
...
//            return isLoggable(priority);
            return true; // deprecated call
        }

        private void prepareLog(int priority, Throwable t, Object messageObject, Object... args) {
         ...
         */
        protected abstract void log(int priority, String tag, Object message, Throwable t);
    }
    ...
    public static class DebugTree extends Tree {
         ...
         */
        @Override
        protected void log(int priority, String tag, Object messageObject, Throwable t) {
            String message = String.valueOf(messageObject);
            if (messageObject instanceof Exception) {
                message = ((Exception) messageObject).getCause().toString();
            }
